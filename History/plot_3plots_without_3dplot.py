...
def update_plots(i, serial_port, data, lines, temp_line, probability_line):
    ...
    return lines + [temp_line, probability_line]
...
def main():
    ...
    # Create animation
    ani = animation.FuncAnimation(fig, update_plots, fargs=(serial_port, data, lines, temp_line, probability_line), interval=100, blit=False)
    plt.show()
